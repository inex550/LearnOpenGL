...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        trans1 = glm::translate(trans1, glm::vec3(-0.3, 0.0, 0.0));
        trans1 = glm::rotate(trans1, glm::radians(currentTime * 30), glm::vec3(0.5f, 1.0f, 0.0f));
        ...
        glUniformMatrix4fv(glGetUniformLocation(program.id(), "transform"), 1, GL_FALSE, glm::value_ptr(trans1));
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);

        float scale = sin(currentTime);

        glm::mat4 trans2(1.0f);
        trans2 = glm::translate(trans2, glm::vec3(0.3, 0.0, 0.0));
        trans2 = glm::scale(trans2, glm::vec3(scale, scale, 0.0));

        glUniformMatrix4fv(glGetUniformLocation(program.id(), "transform"), 1, GL_FALSE, glm::value_ptr(trans2));
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
